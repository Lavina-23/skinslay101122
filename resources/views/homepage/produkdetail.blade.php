      ...
      <div class="row">
        <div class="col-co">
            <div class="card-body-prod">
              ...
              @endif
              <span class="kategori">{{ $itemproduk->kategori->nama_kategori }}</span>
      ...
      <div class="row mt-4">
        <div class="col">
            ...
            <form action="{{ route('cartdetail.store') }}" method="POST">
              ...
              <button class="btn btn-block bg-cream" type="submit">
              <i class="fa fa-shopping-cart"></i> Tambahkan Ke Keranjang
              </button>
            </form>
              <button class="btn btn-block bg-green btn-buy mt-4">
